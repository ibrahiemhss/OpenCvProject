package com.example.ibrahim.opencvproject.cameracalibration;
...
public class CameraCalibrator {
    ...
    private void renderFrame(Mat rgbaFrame) {
        ...
        Imgproc.putText(rgbaFrame, "Video Mode " + mCornersBuffer.size(), new Point(rgbaFrame.cols() / 3 * 2, rgbaFrame.rows() * 0.1),
                3, 1.0, new Scalar(255, 255, 0));
    }
